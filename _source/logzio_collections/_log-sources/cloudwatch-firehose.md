---
title: Ship CloudWatch logs with Firehose Delivery Stream
logo:
  logofile: aws-cloudwatch.svg
  orientation: vertical
data-source: CloudWatch with Firehose Delivery Stream
data-for-product-source: Logs
short-description: Send your data to Logz.io from CloudWatch with Firehose Delivery Stream.
...
open-source:
  - title: Shipping logs from Cloudwatch into Logz.io with Firehose Delivery Stream
    github-repo: firehose-logs
contributors:
  - nshishkin
shipping-tags:
  - aws
