---
title: Ship CloudWatch logs using the Cloudwatch Fetcher Helm Chart
logo:
  logofile: aws-cloudwatch.svg
  orientation: vertical
data-source: CloudWatch over Helm
data-for-product-source: Logs
short-description: Ship CloudWatch logs using the Cloudwatch Fetcher Helm Chart
