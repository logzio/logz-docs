...
| LOGZIO_URL  |  If not specified, the default value will be used, which is attached to `us-east-1`. If your account is hosted in a different reagion, you need to provide the region using `LOGZIO_REGION`. Refer to this [table](to look up the listener URL for your account). | `listener.logz.io:5015` |
