...
| LOGZIO_URL  |  If not specified, the default value will be used. If your account is hosted in a different region, you need to provide the region using `LOGZIO_REGION` in addition to `LOGZIO_URL`. Refer to this [table](to look up the listener URL for your account). | `listener.logz.io:5015` |
