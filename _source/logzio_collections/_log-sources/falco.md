...
Here are just a few examples for security rules written specifically for Falco and provided out-of-the-box by Logz.io's security team:
attempt to remove logging data from a container, attempt to run recon tools inside a container, attempt to add potentially malicious repositories to a container.
