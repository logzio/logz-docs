...
| SetUrl <span class="required-param"></span> <span class="default-param">`https://listener.logz.io:8071`</span> | Listener URL and port. <br> {% include log-shipping/replace-vars-listener.md %} |
