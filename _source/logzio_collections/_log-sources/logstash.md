...
Download the [Logz.io public certificate]({% include log-shipping/certificate-path.md %}) to `C:\ProgramData\ElkStack\logstash-<<YOUR-LOGSTASH-VERSION-NUMBER>>\COMODORSADomainValidationSecureServerCA.crt` on your machine.
...
output {
  lumberjack {
    hosts => ["<<LISTENER-HOST>>"]
    port => 5006
    ssl_certificate => "/C:\ProgramData\ElkStack\logstash-<<YOUR-LOGSTASH-VERSION-NUMBER>>\COMODORSADomainValidationSecureServerCA.crt"
    codec => "json_lines"
  }
}
```
