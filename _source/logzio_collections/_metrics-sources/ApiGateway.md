...
| AWS_NAMESPACES <span class="required-param"></span> | Comma-separated list of namespaces of the metrics you want to collect. <br> For ApiGateway, this is `AWS/ApiGateway`. For the complete list of all valid namespaces, see this [resource](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html). |
{:.paramlist}

{% include metric-shipping/open-dashboard.html title="Cloudwatch AWS/ApiGateway" %}
...
for collecting metrics from ApiGateway.
