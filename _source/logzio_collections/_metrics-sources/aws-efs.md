...
* [Ship EFS metrics over Docker container](#EFS-docker)
* [Ship over self-hosted Metricbeat](#EFS-vanilla)
{:.branching-tabs}
...
| AWS_NAMESPACES <span class="required-param"></span> | Comma-separated list of namespaces of the metrics you want to collect. <br> For EFS, this is `AWS/EFS`. For the complete list of all valid namespaces, see this [resource](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html). |
{:.paramlist}

{% include metric-shipping/open-dashboard.html title="Cloudwatch AWS/EFS" %}
...
for collecting metrics from EFS.
