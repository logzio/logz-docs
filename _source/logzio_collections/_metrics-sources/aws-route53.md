...
* [Ship Route53 metrics over Docker container](#Route53-docker)
* [Ship over self-hosted Metricbeat](#Route53-vanilla)
{:.branching-tabs}


<!-- tab:start -->
<div id="Route53-docker">
...
| AWS_NAMESPACES <span class="required-param"></span> | Comma-separated list of namespaces of the metrics you want to collect. <br> For Route53, this is `AWS/Route53`. For the complete list of all valid namespaces, see this [resource](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/aws-services-cloudwatch-metrics.html). |
{:.paramlist}

{% include metric-shipping/open-dashboard.html title="Cloudwatch AWS/Route53" %}
...
for collecting metrics from Route53.
