...
2. In the **Metrics to be streamed** section, select AWS/KinesisAnalytics and, if required, other namespaces you want to monitor (include/exclude or all namespaces).
