---
title: Send metrics from your OpenTelemetry spans to Logz.io 
logo:
  logofile: span-metrics.png
  orientation: vertical
data-source: OpenTelemetry span metrics
data-for-product-source: Tracing
description: Send metrics from your OpenTelemetry spans to Logz.io 
contributors:
  - nshishkin
shipping-tags:
...
* Configuring the OpenTelemetry collector to receive metrics from spans generated by your OpenTelemetry installation and send them to Logz.io

On deployment, your OpenTelemetry instrumentation captures span metrics from your application and forwards them to the collector, which exports the data to your Logz.io account.
