...
* [Problem: Path is locked](/user-guide/log-troubleshooting/filebeat-troubleshooting.html#problem-path-is-locked)
* [Problem: Old logs are not visible](/user-guide/log-troubleshooting/filebeat-troubleshooting.html#problem-old-logs-are-not-visible)
* [Problem: Invalid yaml](/user-guide/log-troubleshooting/filebeat-troubleshooting.html#problem-invalid-yaml)
