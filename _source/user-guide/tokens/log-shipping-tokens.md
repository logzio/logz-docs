...
The number of log shipping tokens that can be enabled at the same time is limited. <br> Community plans may have up to 3 tokens enabled. Pro and Enterprise plans may have up to 15 tokens enabled.
{:.info-box.note}
